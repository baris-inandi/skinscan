...
labels = (
    [tupl[1] for tupl in healthy]
    + [tupl[1] for tupl in eczema]
    + [tupl[1] for tupl in gangrene]
    + [tupl[1] for tupl in ichthyosis]
    + [tupl[1] for tupl in vitiligo]
)

# Combine the images of all classes together
images = (
    [tupl[0] for tupl in healthy]
    + [tupl[0] for tupl in eczema]
    + [tupl[0] for tupl in gangrene]
    + [tupl[0] for tupl in ichthyosis]
    + [tupl[0] for tupl in vitiligo]
)
