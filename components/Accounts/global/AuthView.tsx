...
const AuthView: React.FC<Props> = (props) => {
  ...
  return (
    <form onSubmit={handleSubmit} onChange={handleChange}>
      <NotchLogo />
      <div className="text-center h-screen w-screen flex items-center justify-center flex-col px-14 gap-3">
        ...
        <input
          ...
          bg-transparent transition-all ease-in-out duration-300 py-3 px-6 w-full border-2 font-sk rounded-md focus:outline-none`}
          type="email"
          name="email"
